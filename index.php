    ...
    <div class="top">
        ...
        <a href="#">
            <div class="right">
                ...
                <div class="header-item">
                    <img class="profile-pic" src="./assets/profile.jpeg">
                </div>
            </div>
        </a>
    </div>
...
<body>
    ...
    <footer>
        <ul class="container">
            <li class="footer-item"><a href="#">Google</a></li>
            <li class="footer-item"><a href="#">Tutto su Google</a></li>
            <li class="footer-item"><a href="#">Privacy</a></li>
            <li class="footer-item"><a href="#">Termini</a></li>
        </ul>
    </footer>
</body>
